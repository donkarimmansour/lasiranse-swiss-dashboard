...
import { convertJsonToExcel, extractDesk, ImageLink } from "../../../shared/funs";
                                        ...
                                        return (
                                            <tr key={ci}>
                                                ...
                                                <td className="d-flex align-items-center">
                                                    <div className="img" style={{ backgroundImage: `url(${ImageLink(admin.image)})` }}></div>
                                                ...
                                                <td className="status"><span className={admin.isAccountActivated ? "active" : "waiting"}>{admin.isAccountActivated ? "Active" : "No"}</span></td>
                                                <td className="status"><span className={admin.isAccountSuspended ? "active" : "waiting"}>{admin.isAccountSuspended ? "Active" : "No"}</span></td>

                                                <td className="multy">
                                                    <span>{moment(new Date(admin.startAt)).format("DD-MM-YYYY")}</span>
                                                    <span>{moment(new Date(admin.endAt)).format("DD-MM-YYYY")}</span>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" className="download" onClick={() => { viewAdmin(admin) }}>
                                                        <span aria-hidden="true"><i className="fa-solid fa-file-arrow-down"></i></span>

                                                    </button>

                                                    <button type="button" className="edit" onClick={() => { editAdmin(admin._id) }}>
                                                        <span aria-hidden="true"><i className="fa-solid fa-pen-to-square"></i></span>
                                                    </button>



                                                    <button type="button" className="delete" onClick={() => { deleteAdmin(admin._id) }}>
