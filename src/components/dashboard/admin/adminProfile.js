...
const AdminProfile = () => {
    ...
    const onSubmit = values => {
        ...
        if (params.id == "new") {
            ...
            const oldSus = (admin.isAccountSuspended === true && isAccountSuspended === "yes-su") ? "eq" :
            (admin.isAccountSuspended === false && isAccountSuspended !== "yes-su") ? "eq" :
            (admin.isAccountSuspended === true && isAccountSuspended !== "yes-su") ? "de" :
            (admin.isAccountSuspended === false && isAccountSuspended === "yes-su") ? "inc" : "eq" ;

            dispatch(updateAccounts(params.id, newVals, authorization  , oldSus))
        }
            ...
            <div className="pform">
                ...
                {params.id != "new" &&
                    <div className="image-profile">
                        <div>
                            <img
                                src={admin && admin.image && ImageLink(admin.image)} alt="edit" />
                                    ...
                                    <Form>
                                        <div className="user-details">
                                            ...
                                            <div className="button">
                                                <input disabled={(loading)} type="submit" value={params.id == "new" ? "add" : "update"} />
                                            </div>
